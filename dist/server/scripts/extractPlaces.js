...
exports.extractPlaces = extractPlaces;
require("dotenv/config");
const config_1 = require("../config");
const database_1 = require("../database");
const placeNormalizer_1 = require("../utils/placeNormalizer");
...
async function extractPlaces() {
    ...
    const existingPlacesCursor = await placesCollection.find({}, { projection: { transaction: 1 } });
    ...
    for await (const item of cursor) {
        ...
        queuedOperations.push({
            insertOne: {
                document: {
                    text: (0, placeNormalizer_1.normalizePlace)(item.transaction),
                    category: '',
