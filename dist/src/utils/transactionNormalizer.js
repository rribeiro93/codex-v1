...
exports.mapCsvRowToTransaction = mapCsvRowToTransaction;
exports.extractStatementMonth = extractStatementMonth;
exports.filterNonNegativeTransactions = filterNonNegativeTransactions;
exports.summarizeTransactions = summarizeTransactions;
exports.getMonthNameFromIsoMonth = getMonthNameFromIsoMonth;
exports.resolveStatementMonthName = resolveStatementMonthName;
const month_names_1 = require("../models/month-names");
...
function normalizeDateCell(value) {
    ...
    if (typeof value === 'number' && Number.isFinite(value)) {
        ...
        if (!Number.isNaN(fromNumber.getTime())) {
            return formatDateParts(fromNumber.getUTCFullYear(), fromNumber.getUTCMonth() + 1, fromNumber.getUTCDate());
        }
    }
...
function extractStatementMonth(fileName) {
...
function filterNonNegativeTransactions(transactions) {
...
function getMonthNameFromIsoMonth(value) {
    ...
    return month_names_1.MONTH_NAMES[monthIndex] ?? '';
}
...
function resolveStatementMonthName({ month, fileName, transactions }) {
