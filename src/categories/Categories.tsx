...
import { CategoryRecord } from '../models/category-record';
...
function createCategoryViewModel(category: RawCategory | null | undefined): CategoryRecord | null {
    ...
    const loadCategories = async () => {
      ...
      try {
        ...
        const mapped = sortCategories(
          receivedCategories
            .map((raw) => createCategoryViewModel(raw as RawCategory))
