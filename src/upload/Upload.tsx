...
import { StatementPayload } from '../models/statement-payload';

const createEmptyStatement = (): StatementPayload => ({
  month: '',
  monthName: '',
  totalAmount: 0,
  totalTransactions: 0,
...
export default function Upload() {
  ...
  const [statement, setStatement] = useState<StatementPayload>(createEmptyStatement);
  ...
  const persistStatement = async (payload: StatementPayload, sourceFileName: string) => {
  ...
  const handleFileSelection = async (event: ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const statementPayload: StatementPayload = {
        month,
        monthName,
        totalAmount,
        totalTransactions,
